...
<?foreach($arResult["ITEMS"] as $arItem):?>
    ...
    <td ><?$cur_date=explode(" ", format_date($arItem["DISPLAY_ACTIVE_FROM"]));?>
	<p class="DayOfNews"><?echo $cur_date[0]?></p>
	<p class="MonthOfNews"><?echo $cur_date[1]?></p>
	<p class="YearOfNews"><?echo $cur_date[2]?></p>
	</td>
		<td>
		<?if($arParams["DISPLAY_NAME"]!="N" && $arItem["NAME"]):?>
			<?if(!$arParams["HIDE_LINK_WHEN_NO_DETAIL"] || ($arItem["DETAIL_TEXT"] && $arResult["USER_HAVE_ACCESS"])):?>
			<p class="TitleOfNews" style="color:#01b4dd;"><a href="<?echo $arItem["DETAIL_PAGE_URL"]?>"><?echo $arItem["NAME"]?></a></p><br />
			<?else:?>
			<p class="TitleOfNews" style="color:#01b4dd;"><?echo $arItem["NAME"]?></p><br />
			<?endif;?>
		<?endif;?>
		</td>
		</tr>
